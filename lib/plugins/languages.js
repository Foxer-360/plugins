...
function () {
  ...
  Languages.prototype.resolveNavigations = function () {
    ...
    console.log('Plugins language website', website);
    this.client.query({
      query: WEBSITE_QUERY,
      variables: {
        website: website
      ...
      // tslint:disable-next-line:no-console
      console.log('Plugins language dataWebsite', dataWebsite);
      ...
      console.log('Plugins language contextLanguages', contextLanguages);
