...
var NAVIGATION_QUERY = (0, _graphqlTag.default)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  query navigations($website: ID!) {\n    navigations(\n      where: {\n        website: {\n          id_in: [$website]\n        }\n      }\n    ) {\n      name\n      nodes {\n        page\n        order\n        parent\n      }\n    }\n  }\n"], ["\n  query navigations($website: ID!) {\n    navigations(\n      where: {\n        website: {\n          id_in: [$website]\n        }\n      }\n    ) {\n      name\n      nodes {\n        page\n        order\n        parent\n      }\n    }\n  }\n"])));
...
function () {
  function Navigations(context, config, client) {
    ...
    this.client = client;
    this.listeners = [];
    this.context.writeProperty('navigation', null); // Add listeners on context
  ...
  Navigations.prototype.resolveNavigations = function () {
    ...
    this.client.query({
      ...
      _this.context.writeProperty('navigation', transformed);
    });
  };
